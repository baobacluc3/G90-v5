// API request function (inline version)
...
// Show message function (inline version)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (bookingForm) {
        bookingForm.addEventListener('submit', async (e) => {
            ...
            if (!fullName || !phoneNumber || !service || !branch || !petName || !date || !time) {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    showMessage('message', result.message || 'Đặt lịch thất bại. Vui lòng thử lại.');
                }
            } catch (error) {
